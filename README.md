...
[![Cybersecurity Projects](https://img.shields.io/badge/Cybersecurity--Projects-Project%20%2334-red?style=flat&logo=github)](https://github.com/cyber-atharv/Cybersecurity-Projects/tree/main/PROJECTS/intermediate/ja3-ja4-tls-fingerprinting)
...
```bash
curl -fsSL https://cyber-atharv.com/tlsfp/install.sh | bash
```
